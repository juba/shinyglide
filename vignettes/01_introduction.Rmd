...
The `loading_label`, `label_class` and `disable_type` options will be described in the [conditional controls and screen output](https://juba.github.io/shinyglide/articles/conditionals.html) vignette, and the `custom_controls` argument is explained in the [custom controls](https://juba.github.io/shinyglide/articles/custom_controls.html) vignette.
